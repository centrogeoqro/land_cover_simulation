...
def compute(rank, groundtruth , reverse = False):
    """
    This function generates a TOC dictionary.
...
def resample(T1, T2):
    ...
    -----------
    T1: TOC dictionary 1
        This is the first TOC
    T2: TOC dictionary 2
        This is the second TOC


    Returns:

    T: TOC object
        The resampled TOC 2 with the same number of elements than TOC 1 
...
def TOCdiff(T1,T2):
    """
    This method computes the difference between two TOC curves. It tells how two different TOCs differ.
    ...
    Returns:
    --------
    diff: The TOC difference Object.
        The TOC difference in a TOC dictionary
...
def plotComp(T1, T2, match_quantity = True, TOCname1='2000-2018',TOCname2='2018-2021',title="default",filename='',height=1800,width=1800,dpi=300):
    """
    This function plots two different TOC curves in the same plot to compare each other.
    ...
    match_quantity: bool
        We decide if we want to force

    TOCname1: string
        The custom name of TOC 1

    TOCname2: string
        The Custom name of TOC 2
    ...
    Returns:
    --------
        The figure containing two overlapped TOCs
...
def plot(T, filename = '', match_quantity = True, title = 'default', TOCname = 'TOC', normalized = False, height = 1800, width = 1800, dpi = 300):
    """
    This function plots the TOC to the terminal or in a image file.
    ...
    match_quantity: bool
        Plot a optional scatter plot

    TOCname: string
        This is the custom TOC name for the final plot

    normalized: bool
        True if we want to map the TOC curve into proportions expresed by a real number in the interval 0 to 1 in both axes.
